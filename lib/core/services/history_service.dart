...
class HistoryService {
  ...
  static Future<void> savePostToHistory(PostEntity post) async {
    try {
      ...
      final historyList = _getHistoryList(box);
      ...
      await box.put('user_history', jsonEncode(historyList));
    } catch (e) {
  ...
  static List<Map<String, dynamic>> _getHistoryList(Box box) {
    final historyData = box.get('user_history');
